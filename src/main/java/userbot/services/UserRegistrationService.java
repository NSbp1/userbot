...
public class UserRegistrationService {
    ...
    public UserRegistrationService(UserService userService, UserSessionService userSessionService) {
        this.userService = userService;
        this.userSessionService = userSessionService;

        // Pass the required UserSessionService to the handler
        this.stageHandler = new UserRegistrationStageHandler(userSessionService,userService);
    ...
    public String registerUser(JSONObject json, UserSession session) throws SQLException {
